...
model_endpoint = "mrm8488/bert-mini2bert-mini-finetuned-cnn_daily_mail-summarization"
# model_endpoint = 'mrm8488/bert-small2bert-small-finetuned-cnn_daily_mail-summarization'
...
tokenizer = BertTokenizerFast.from_pretrained(model_endpoint.split('/')[1])
model = EncoderDecoderModel.from_pretrained(model_endpoint.split('/')[1]).to(device)
...
be interested in
"""
summarized_text = generate_summary(new_context)
# %%
print(summarized_text)
# %%
save_model = False
if save_model: 
    tokenizer.save_pretrained(model_endpoint.split('/')[1])
    model.save_pretrained(model_endpoint.split('/')[1])
# %%
